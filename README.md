...
---
![Banner PAI](https://github.com/GrupoMackenzie/ProjetoAplicado03-DataScience-Mackenzie-2026/blob/main/docs/imagens/Banner%20PA03.png)
...
└── 📂 Imagens/ → 
├── 📂 datasets/ → 
├── 📂 src/ → Scripts de processamento dos dados <br>
...
### 📌 Etapas do Projeto
---
1️⃣ **Etapa 1: Definição e Planejamento** 📋 *()*
   - Definição do Grupo 
   ...
   - Entrega da Etapa 1  
---
2️⃣ **Etapa 2: Análise Explorátoria e Proposta Analítica** 🔍 *()*
   ...
   - Entrega da Etapa 2 
---
3️⃣ **Etapa 3: Apresentação e Data Storytelling** 📊 *()*
   ...
   - Entrega da Etapa 3  
---
4️⃣ **Etapa 4: Finalização e Apresentação** 🎥 *()*
