...
Video game requirements v2 (videogame_requirements.csv)

* https://www.kaggle.com/datasets/baraazaid/pc-video-game-requirements-v2

CPU benchmarks compilation (cpu_benchmark_v4.csv)

* https://www.kaggle.com/datasets/alanjo/cpu-benchmarks

GPU benchmarks compilation (gpu_benchmarks_v7.csv)

* https://www.kaggle.com/datasets/alanjo/gpu-benchmarks/

Popular CPU/GPU dataset (cpu.csv and gpu.csv)
